...
@dataclass
class WeightedCrossEntropyCriterionConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")


@register_criterion("weighted_cross_entropy", dataclass=WeightedCrossEntropyCriterionConfig)
class WeightedCrossEntropy(FairseqCriterion):
